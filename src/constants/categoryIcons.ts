...
export const categoryIcons = {
	Appetizer: { icon: "mdi:food-outline" },
	BBQ: { icon: "mdi:grill-outline" },
	Beverage: { icon: "mdi:glass-cocktail" },
	Breakfast: { icon: "mdi:weather-sunset" },
	Chicken: { icon: "mdi:food-drumstick-outline" },
	Dessert: { icon: "mdi:cupcake" },
	FastFood: { icon: "mdi:hamburger" },
	GlutenFree: { icon: "mdi:alpha-g-circle-outline" },
	Healthy: { icon: "mdi:heart-outline" },
	...
	Vegetarian: { icon: "mdi:food-apple-outline" },
	Wraps: { icon: "mdi:wrap" },
};
